((function() {
    ...
    exports.compileFile = compileFile = function(filename, gen1_options) {
        ...
        ugly = gen1_options && gen1_options.ugly != null ? gen1_options.ugly : false;
    ...
    exports.compile = function(pogo, gen4_options) {
        ...
        filename = gen4_options && gen4_options.filename != null ? gen4_options.filename : void 0;
        inScope = gen4_options && gen4_options.inScope != null ? gen4_options.inScope : true;
        ugly = gen4_options && gen4_options.ugly != null ? gen4_options.ugly : false;
    ...
    compileFromFile = function(filename, gen6_options) {
        var ugly, contents;
        ugly = gen6_options && gen6_options.ugly != null ? gen6_options.ugly : false;
    ...
    sourceLocationPrinter = function(gen7_options) {
        var filename, source;
        filename = gen7_options && gen7_options.filename != null ? gen7_options.filename : void 0;
        source = gen7_options && gen7_options.source != null ? gen7_options.source : void 0;
        return object(function() {
            ...
            self.printLinesInRange = function(gen8_options) {
                ...
                from = gen8_options && gen8_options.from != null ? gen8_options.from : void 0;
                to = gen8_options && gen8_options.to != null ? gen8_options.to : void 0;
                self = this;
