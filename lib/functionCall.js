((function() {
    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            makeAsyncCallWithResult: function(resultVariable, errorVariable, statements) {
                var self, fc;
                self = this;
                fc = self.clone();
                fc.functionArguments.push(terms.closure([ errorVariable, resultVariable ], terms.statements(statements)));
                return fc;
            }
        });
    };
