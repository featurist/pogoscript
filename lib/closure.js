((function() {
    ...
    module.exports = function(terms) {
        var self, optionalParameters, optional, asyncParameters, containsSplatParameter, createSplatParameterStrategyFor, createOptionalParameterStrategyFor;
        self = this;
        ...
        return terms.term({
            ...
            parameterTransforms: function() {
                var self, optionals, async, splat;
                self = this;
            ...
            generateJavaScript: function(buffer, scope) {
                var self, parametersStrategy, parameters, bodyScope;
                self = this;
            ...
            parametersStrategy: function() {
                var self, innerStrategy, strategy;
                self = this;
