((function() {
    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            serialiseSubStatements: function(statements, clone, isStatement) {
                var self;
                self = this;
                if (!isStatement) {
                    return clone(terms.functionCall(terms.closure([], terms.statements([ self.rewriteResultTermInto(function(term) {
