(function() {
    ...
    module.exports = function(cg) {
        ...
        Term = classExtending(Node, {
            ...
            codeIntoBuffer: function(buffer, generateCodeIntoBuffer) {
                var self = this;
                return generateCodeIntoBuffer(buffer);
            },
            generateIntoBuffer: function(generateCodeIntoBuffer) {
                var self = this;
                var buffer;
                buffer = new ms.MemoryStream();
                generateCodeIntoBuffer(buffer);
                return buffer.toString();
            },
            withBuffer: function(block) {
                var self = this;
                var buffer;
                buffer = new ms.MemoryStream();
                block(buffer);
            ...
            generate: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScript(buffer, scope);
                });
            },
            generateStatements: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScriptStatements(buffer, scope);
                });
            },
            generateStatement: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScriptStatement(buffer, scope);
                });
            },
            generateHashEntry: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScriptHashEntry(buffer, scope);
                });
            },
            generateStatementsReturn: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScriptStatementsReturn(buffer, scope);
                });
            },
            generateModule: function(scope) {
                var self = this;
                return self.withBuffer(function(buffer) {
                    return self.generateJavaScriptModule(buffer, scope);
                });
            }
        });
