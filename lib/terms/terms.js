(function() {
    ...
    module.exports = function(cg) {
        ...
        Node = $class({
            ...
            walkDescendants: function(walker, gen25_options) {
                var self = this;
                var limit;
                limit = gen25_options !== void 0 && Object.prototype.hasOwnProperty.call(gen25_options, "limit") && gen25_options.limit !== void 0 ? gen25_options.limit : function() {
                    return false;
                };
                var path, walkChildren;
                path = [];
                walkChildren = function(node) {
                    var gen26_items, gen27_i, child;
                    try {
                        path.push(node);
                        gen26_items = node.children();
                        for (gen27_i = 0; gen27_i < gen26_items.length; ++gen27_i) {
                            child = gen26_items[gen27_i];
                            walker(child, path);
                            if (!limit(child, path)) {
                                walkChildren(child);
                            }
            ...
            reduceWithReducedChildrenInto: function(reducer, gen28_options) {
                var self = this;
                var limit, cacheName;
                limit = gen28_options !== void 0 && Object.prototype.hasOwnProperty.call(gen28_options, "limit") && gen28_options.limit !== void 0 ? gen28_options.limit : function(term) {
                    return false;
                };
                cacheName = gen28_options !== void 0 && Object.prototype.hasOwnProperty.call(gen28_options, "cacheName") && gen28_options.cacheName !== void 0 ? gen28_options.cacheName : void 0;
                ...
                mapReduceChildren = function(node) {
                    var mappedChildren, gen29_items, gen30_i, child;
                    try {
                        path.push(node);
                        mappedChildren = [];
        ...
        Term = classExtending(Node, {
            ...
            inspectTerm: function(gen31_options) {
                var self = this;
                var depth;
                depth = gen31_options !== void 0 && Object.prototype.hasOwnProperty.call(gen31_options, "depth") && gen31_options.depth !== void 0 ? gen31_options.depth : 20;
                var util;
                util = require("util");
                return util.inspect(self, false, depth);
            },
            show: function(gen32_options) {
                var self = this;
                var desc, depth;
                desc = gen32_options !== void 0 && Object.prototype.hasOwnProperty.call(gen32_options, "desc") && gen32_options.desc !== void 0 ? gen32_options.desc : void 0;
                depth = gen32_options !== void 0 && Object.prototype.hasOwnProperty.call(gen32_options, "depth") && gen32_options.depth !== void 0 ? gen32_options.depth : 20;
                if (desc) {
            ...
            expandMacros: function() {
                var self = this;
                return self.clone({
                    rewrite: function(term, gen33_options) {
                        var clone;
                        clone = gen33_options !== void 0 && Object.prototype.hasOwnProperty.call(gen33_options, "clone") && gen33_options.clone !== void 0 ? gen33_options.clone : void 0;
            ...
            rewriteAllStatements: function() {
                var self = this;
                return self.clone({
                    rewrite: function(term, gen34_options) {
                        var clone;
                        clone = gen34_options !== void 0 && Object.prototype.hasOwnProperty.call(gen34_options, "clone") && gen34_options.clone !== void 0 ? gen34_options.clone : void 0;
        ...
        term = function(members) {
            ...
            return function() {
                ...
                gen35_c.prototype = termConstructor.prototype;
                return new gen35_c();
            };
        };
        return {
