(function() {
    ...
    module.exports = function(terms) {
        ...
        return functionCall = function(fun, args, gen2_options) {
            ...
            var asyncResult, futureFunction, callback, promisifyFunction, name, macro, funCall;
            if (async) {
                ...
                return terms.functionCall(promisifyFunction, [ terms.closure([ terms.callbackFunction ], terms.statements([ terms.functionCall(fun, args, {
                    optionalArguments: [],
                    async: false,
