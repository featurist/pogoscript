            ...
            if (inScope) {
                ...
                call = function() {
                    if (statements.isAsync) {
                        ...
                        return terms.methodCall(methodCall, [ "then" ], [ terms.closure([], terms.statements([])), terms.closure([ errorVariable ], terms.statements([ terms.throwStatement(errorVariable) ])) ]);
                    } else {
                        return methodCall;
                    }
                }();
