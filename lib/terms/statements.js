        ...
        return terms.term({
            ...
            promisify: function(gen3_options) {
                ...
                if (!self.returnsPromise) {
                    return terms.statements([ terms.functionCall(terms.createPromise(), [ terms.closure([ terms.resolveFunction, terms.continuationFunction ], self, {
                        inPromise: true,
                        async: true
                    }) ]) ], {
                        returnsPromise: true,
            ...
            rewriteLastStatementToReturn: function(gen5_options) {
                ...
                returnCallToContinuation = gen5_options !== void 0 && Object.prototype.hasOwnProperty.call(gen5_options, "returnCallToContinuation") && gen5_options.returnCallToContinuation !== void 0 ? gen5_options.returnCallToContinuation : true;
            ...
            generateVariableDeclarations: function(variables, buffer, scope, gen6_options) {
                var self = this;
                var global;
