(function() {
    ...
    module.exports = function(terms) {
        ...
        return asyncCallback = function(body, gen1_options) {
            ...
            if (!body.containsContinuation()) {
                body.rewriteResultTermInto(function(term) {
                    if (!term.originallyAsync) {
                        return terms.returnStatement(terms.functionCall(terms.continuationFunction, [ terms.nil(), term ]), {
                            implicit: true
                        });
                    } else {
                        return term;
            ...
            return terms.functionCall(rethrowErrors, [ terms.continuationFunction, terms.closure([ resultVariable ], body, {
