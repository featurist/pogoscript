(function() {
    ...
    module.exports = function(terms) {
        ...
        return methodCall = function(object, name, args, gen2_options) {
            ...
            var splattedArgs, objectVar, asyncResult, promisifyFunction, futureFunction;
            ...
            if (splattedArgs && !containsSplatArguments) {
                ...
                return terms.functionCall(promisifyFunction, [ terms.closure([ terms.callbackFunction ], terms.statements([ methodCall(object, name, args, {
                    optionalArguments: [],
                    async: false,
                    future: false,
