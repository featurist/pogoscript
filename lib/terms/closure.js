    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            constructor: function(parameters, body, gen1_options) {
                var self = this;
                var optionalParameters, returnLastStatement, redefinesSelf, async, definesModuleConstants, inPromise, returnPromise;
                ...
                if ((body.isAsync || returnPromise) && !inPromise) {
            ...
            blockify: function(parameters, gen2_options) {
                ...
                self.parameters = parameters;
                self.optionalParameters = optionalParameters;
                if (returnPromise && !self.returnsPromise) {
