(function() {
    var self = this;
    var ms, fs, Module, path, repl, versions, compiler, createTerms, runningOnNodeOrHigher, compileFile, whenChanges, jsFilenameFromPogoFilename, compileFromFile;
