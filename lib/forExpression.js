((function() {
    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            scopedBody: function() {
                var self, loopStatements, forResultVariable, cg, statements;
                self = this;
                loopStatements = [];
                ...
                statements = self.statements.clone({
                    rewrite: function(term) {
                        ...
                        self = this;
                        if (term.isReturn) {
                            return cg.statements([ cg.definition(forResultVariable, term.expression), cg.returnStatement(cg.boolean(true)) ], {
                                expression: true
                            });
                        }
                    },
