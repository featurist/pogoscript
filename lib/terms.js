((function() {
    ...
    module.exports = function(cg) {
        ...
        Term = classExtending(Node, {
            ...
            blockify: function(parameters, optionalParameters, gen10_options) {
                var async, self, b;
                async = gen10_options && gen10_options.hasOwnProperty("async") && gen10_options.async !== void 0 ? gen10_options.async : false;
                self = this;
            ...
            expandMacros: function() {
                ...
                self = this;
                return self.clone({
                    rewrite: function(term, gen11_options) {
                        var clone;
                        clone = gen11_options && gen11_options.hasOwnProperty("clone") && gen11_options.clone !== void 0 ? gen11_options.clone : void 0;
        ...
        term = function(members) {
            ...
            return function() {
                ...
                gen12_c.prototype = termConstructor.prototype;
                return new gen12_c;
            };
        };
        return {
