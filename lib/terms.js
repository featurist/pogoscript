    ...
    module.exports = function(cg) {
        ...
        Node = $class({
            ...
            clone: function(gen1_options) {
                var rewrite, limit, createObject, self, cloneObject, cloneNode, cloneArray, cloneSubterm;
                ...
                createObject = gen1_options && gen1_options.hasOwnProperty("createObject") && gen1_options.createObject !== void 0 ? gen1_options.createObject : function(node) {
        ...
        Term = classExtending(Node, {
            ...
            blockify: function(parameters, gen12_options) {
                ...
                optionalParameters = gen12_options && gen12_options.hasOwnProperty("optionalParameters") && gen12_options.optionalParameters !== void 0 ? gen12_options.optionalParameters : void 0;
