((function() {
    ...
    module.exports = function(cg) {
        ...
        term = $class({
            ...
            expandMacros: function() {
                ...
                self = this;
                return self.clone({
                    rewrite: function(term, gen9_options) {
                        var clone;
                        clone = gen9_options && gen9_options.hasOwnProperty("clone") && gen9_options.clone !== void 0 ? gen9_options.clone : void 0;
    ...
    module.exports.term = function(members) {
        ...
        return function() {
            ...
            gen10_c.prototype = termConstructor.prototype;
            return new gen10_c;
        };
    };
})).call(this);