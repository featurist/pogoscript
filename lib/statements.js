((function() {
    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            rewriteAsyncCallbacks: function(statements) {
                var self, n, gen2_forResult;
                self = this;
            ...
            serialiseStatements: function(statements) {
                var self, serialisedStatements, gen3_items, gen4_i, statement;
                self = this;
                serialisedStatements = [];
                gen3_items = statements;
                for (gen4_i = 0; gen4_i < gen3_items.length; gen4_i++) {
                    statement = gen3_items[gen4_i];
                    serialisedStatements.push(statement.clone({
