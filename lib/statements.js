    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            rewriteAsyncCallbacks: function(gen2_options) {
                var returnLastStatement, forceAsync, callbackFunction, self, statements, madeStatementsReturn, detectedAsyncCall, statementsWithReturn, n, gen3_forResult;
                ...
                callbackFunction = gen2_options && gen2_options.hasOwnProperty("callbackFunction") && gen2_options.callbackFunction !== void 0 ? gen2_options.callbackFunction : terms.generatedVariable([ "callback" ]);
                self = this;
                statements = self._serialiseStatements(self.statements);
                madeStatementsReturn = false;
                detectedAsyncCall = forceAsync;
                statementsWithReturn = function() {
                    var returnTerm;
                    if (!madeStatementsReturn) {
                        returnTerm = function(term) {
                            if (returnLastStatement && detectedAsyncCall) {
                ...
                for (n = 0; n < statements.length; n = n + 1) {
                    ...
                    if (function(n) {
                        ...
                        asyncStatement = statement.makeAsyncWithStatements(function(errorVariable) {
                            detectedAsyncCall = true;
                            return self._wrapCallbackStatements(statementsWithReturn().slice(n + 1), {
            ...
            _wrapCallbackStatements: function(callbackStatements, gen4_options) {
                var errorVariable, callbackFunction, self, catchErrorVariable;
                errorVariable = gen4_options && gen4_options.hasOwnProperty("errorVariable") && gen4_options.errorVariable !== void 0 ? gen4_options.errorVariable : void 0;
                callbackFunction = gen4_options && gen4_options.hasOwnProperty("callbackFunction") && gen4_options.callbackFunction !== void 0 ? gen4_options.callbackFunction : void 0;
                self = this;
