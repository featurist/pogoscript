((function() {
    ...
    module.exports = function(terms) {
        ...
        return terms.term({
            ...
            rewriteAsyncCallbacks: function(gen1_options) {
                var returnLastStatement, callbackFunction, self, returnTerm, statements, n, gen2_forResult;
                ...
                callbackFunction = gen1_options && gen1_options.hasOwnProperty("callbackFunction") && gen1_options.callbackFunction !== void 0 ? gen1_options.callbackFunction : void 0;
                self = this;
            ...
            blockify: function(parameters, optionalParameters, gen3_options) {
