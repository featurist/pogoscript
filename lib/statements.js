                ...
                for (n = 0; n < statements.length; n = n + 1) {
                    ...
                    if (function(n) {
                        ...
                        asyncStatement = statement.makeAsyncWithStatements(function() {
                            ...
                            return [ terms.tryExpression(terms.statements(statementsWithReturn({
                                async: true
                            }).slice(n + 1)), {
                                catchParameter: errorVariable,
                                catchBody: terms.statements([ terms.functionCall(callbackFunction, [ errorVariable ]) ])
                            }) ];
                        });
                        if (asyncStatement) {
